...
const BusinessList: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white p-6 min-h-screen">
      <h1 className="text-2xl font-bold mb-6 text-gold">מצא את העסק המתאים</h1>
      ...
      <h2 className="text-2xl font-semibold mb-4 text-gold">עסקים ב{selectedCity}</h2>
      {businesses.length > 0 ? (
        ...
        selectedCity && <p className="text-gray-400">No businesses found for this city.</p>
      )}
