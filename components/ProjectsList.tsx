...
const ProjectsList: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white p-6 min-h-screen">
      <h1 className="text-2xl font-bold mb-6 text-gold">מצא את הפרויקט המתאים</h1>
      ...
      <h2 className="text-2xl font-semibold mb-4 text-gold">פרויקטים ב{selectedCity}</h2>
      {projects.length > 0 ? (
        ...
        selectedCity && <p className="text-gray-400">No projects found for this city.</p>
      )}
